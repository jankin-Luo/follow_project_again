...
class Test_aboutMaterial:
    ...
    # 参数化，yaml数据驱动
    @pytest.mark.parametrize('baseinfo,testcase', get_testcase_yaml("./testcase/ruoyitest/xiadan.yaml"))
    ...
    # 参数化，yaml数据驱动
    @pytest.mark.parametrize('baseinfo,testcase', get_testcase_yaml("./testcase/ruoyitest/ruoyitest.yaml"))
